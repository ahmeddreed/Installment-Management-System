            ...
            <div class="col-6 mx-auto mt-5">
                <div class="card shadow rounded">
                    ...
                    <div class="card-body new-color">
                        ...
                        <form action="{{ route("updateCategory",["id"=>$category->id]) }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="name" type="text" value="{{ $category->name }}" class="form-control  @error('name') is-invalid  @enderror" id="exampleFormControlInput1" placeholder="البريد الالكتروني">
                                @error('name')
                    ...
                    <div class="card-footer new-bg">
                        <div>
                            <a href="{{ route("CategoryTable") }}" class="btn btn-light fs-5 new-color rounded">الرجوع</a>
                        </div>
                    </div>
                </div>
            </div>
