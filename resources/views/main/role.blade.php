            ...
            <div class="col-10 mx-auto mt-5">
                <div class="card shadow new-color rounded">
                    <div class="card-header new-bg ">
                        <h3 class="float float-end">جدول صلاحيات</h3>
                        <button type="button" class="btn btn-light new-color rounded float float-start" data-bs-toggle="modal" data-bs-target="#Add">اضافة صلاحية</button>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">الاسم الصلاحية</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            @php
                                                $key = Hash::make($role->id);
                                            @endphp
                                            <a data-bs-toggle="modal" data-bs-target="#del{{ $role->id }}" class="me-2"><i class="bi bi-trash-fill text-danger"></i></a>
                                            <a href="{{ route("editRole",["id"=>$role->id]) }}" class="me-2"><i class="bi bi-pencil-fill text-warning"></i></a>
                                        </td>
                                        </tr>

                                        {{-- delete modal --}}
                                        <div class="modal fade new-text" id="del{{ $role->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-body">
                                                    <div class="card shadow new-color rounded">
                                                        ...
                                                        <div class="card-body mx-auto">
                                                            ...
                                                            <form class="d-inline" action="{{ route("deleteRole",["id"=>$role->id]) }}" method="post">
                                                                @csrf
                                                                @method("delete")
