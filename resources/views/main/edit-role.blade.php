...
<html lang="en">
  ...
  <body dir="rtl">
    <div class="container">
        <div class="row">
            {{-- the alert message --}}
            <div class="col-lg-10 col-md-8 mx-auto mt-5">
                    ...
                    <div class="card-body new-color">
                        ...
                        <form action="{{ route("updateRole",["id"=>$role->id]) }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="name" type="text" value="{{ $role->name }}" class="form-control  @error('name') is-invalid  @enderror" id="exampleFormControlInput1" placeholder="البريد الالكتروني">
                                @error('name')
